...
_RULES_DB: dict[str, float] = {
    ...
    # COR / L (Ailes égales)
    "L 30*30*3": 1.36, "L 40*40*4": 2.42, "L 50*50*5": 3.77, "L 60*60*6": 5.42, 
    "L 70*70*7": 7.38, "L 80*80*8": 9.66, "L 90*90*9": 12.20, "L 100*100*10": 15.10,
    "L 120*120*12": 21.60, "L 150*150*15": 33.80, "L 200*200*20": 59.90,
}
